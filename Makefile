...
verify: coq
	...
	@cd coq && coqchk -silent -R . DwellFiber DwellFiber.dwell_stable DwellFiber.dwell_kernel_resilience DwellFiber.dwell_extended DwellFiber.test_resilience && echo "Verification complete"
